...
/*   Updated: 2022/05/16 23:08:02 by antti            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				precision_catcher(const char *s, t_flags *flags,
						va_list args);
...
void				octal_creator(unsigned long long int nbr,
						t_flags *flags);
void				hex_creator(unsigned long long nbr, const char spec,
						t_flags *flags);
int					print_hex(unsigned long long nbr, const char spec,
						t_flags flags);
